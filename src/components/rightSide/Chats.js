...
function handleChange(){
  ...
  const imag=personData.find((e)=>e.id===activeUsers.toLowerCase()?e:null)
  ...
  return (
    <div className='user-profile'>
      ...
      <div className='input-message'>
        <input type='text' placeholder='Enter Text' ref={inpRef}  />
        <span onClick={()=>handleChange()}><BiSend className='send-icon'/></span>
      </div>
    </div>
  )
}
